                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 border-t border-border/10 pt-3">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs font-bold uppercase">{transaction.provider} - {transaction.package}</p>
                    </div>
                    <div className="space-y-0.5 text-right">
                      <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/40">Amount</p>
                      <p className="text-base font-black tracking-tight">₦{transaction.amount?.toLocaleString()}</p>
                    </div>
                  </div>
